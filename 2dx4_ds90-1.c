...
//This port is used to read the button press
...
void PortH_Init(void){
  ...
  //GPIO_PORTH_PCTL_R = (GPIO_PORTM_PCTL_R&0xFFFFFF0F)+0x00000000;
...
void DutyCycle_Percent(duty){
				float percent;	
				percent = ((float)duty*1000)/(255);
				int percent_int;
				percent_int = (int)percent;
				GPIO_PORTN_DATA_R ^= 0b00000100;
				SysTick_Wait10ms(percent_int);  //Note the use of the new function 10ns instead of 10ms
				GPIO_PORTN_DATA_R ^= 0b00000100;
...
/* Those basic I2C read functions can be used to check your own I2C functions */
  ...
  status = VL53L1X_StartRanging(dev);   /* This function has to be called to enable the ranging */
	...
	//this checks if the PC sends out a 'high'
	while(check == 0x31){
		
			//This if statement checks if the external button is pressed
			...
			if((GPIO_PORTM_DATA_R&0b00000001)==0b00000000){
				//This loop is used to rotate the stepper motor
				for(int num1 = 0; num1 < 64; num1++){
					//This loop runs 512 times (i.e full rotation)
					for (int num2 = 0 ; num2 <8 ; num2++){
							CW_Spin(); 
					}
					
					//every 5.625 degrees the ToF Sensor takes a measurement
					while (dataReady == 0){
